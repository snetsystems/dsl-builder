...
import { SerializedFieldFormat } from 'src/type'
...
export class IndexPattern {
  ...
  public formatHit: {
    (hit: Record<string, any>, type?: any): any
  ...
  private fieldSpecsToFieldFormatMap = (
    ...
    Object.values(fldList).reduce<Record<string, any>>((col, fieldSpec) => {
      if (fieldSpec.format) {
  ...
  getFormatterForField(
    field: IndexPatternField | IndexPatternField['spec'] | any
  ): any {
    return (
      this.fieldFormatMap[field.name] ||
      this.fieldFormats.getDefaultInstance(
        field.type as any,
        field.esTypes as any[]
      )
    )
  }
}
