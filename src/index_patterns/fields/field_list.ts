...
export const fieldList = (
  ...
  class FldList
    extends Array<IndexPatternField>
    implements IIndexPatternFieldList {
    private byName: FieldMap = new Map()
    private groups: Map<IndexPatternField['type'], FieldMap> = new Map()
    private setByName = (field: IndexPatternField) =>
    ...
    private removeByGroup = (field: IFieldType) =>
    ...
    public readonly getByName = (name: IndexPatternField['name']) =>
